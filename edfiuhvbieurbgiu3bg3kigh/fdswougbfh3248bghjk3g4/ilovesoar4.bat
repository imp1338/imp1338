@echo off
taskkill /f /im FortniteClient-Win64-Shipping_EAC.exe >NUL 2>NUL
taskkill /f /im FortniteClient-Win64-Shipping.exe >NUL 2>NUL
taskkill /f /im FortniteClient-Win64-Shipping_BE.exe >NUL 2>NUL
taskkill /f /im FortniteLauncher.exe >NUL 2>NUL
...
del "CC:\System Volume Information\tracking.log",
